  ...
  <head>
    ...
    <script>
      ...
      function loadAllPatients() {
        fetch("ReceptionListServlet?query=")
      ...
      function renderTableRows(data, tbody) {
    	  ...
    	  if (!data || data.length === 0) {
    	    tbody.innerHTML = "<tr><td colspan='5' class='no-results'>No patients found</td></tr>";
    	    return;
    	  }
    	  ...
    	  for (let i = 0; i < data.length; i++) {
    	    ...
    	    tableContent += "<tr>" +
    	      ...
    	      '<a href="ReceptionListReserveServlet?id=' + patient.id + '" class="view-btn">Reserve</a>' +
    	      "</td>" +
    	      "</tr>";
    	  }
