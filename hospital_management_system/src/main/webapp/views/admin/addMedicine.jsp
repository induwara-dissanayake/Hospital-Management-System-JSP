    ...
    <div class="form-container">
      ...
      <form action="${pageContext.request.contextPath}/MedicineServlet?action=addMedicine" method="post">
        ...
        <div class="input-group">
          ...
          <input type="text" name="dosageForm" placeholder="Dosage Form" required />
        </div>
        <div class="input-group">
          <i class="fas fa-balance-scale"></i>
          <input type="text" name="dosageStrength" placeholder="Dosage Strength" required />
        </div>
        <div class="input-group">
        ...
        <div class="input-group">
          ...
          <input type="text" name="prescribedFor" placeholder="Prescribed For" required />
        </div>
        <div class="input-group">
