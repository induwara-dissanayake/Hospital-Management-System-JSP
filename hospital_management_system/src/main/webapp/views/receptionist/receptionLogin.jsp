...
<head>
  ...
  <title>Reception Login | Hospital Management System</title>
...
<body class="bg-[#edf7ff] min-h-screen flex flex-col justify-center items-center px-4">
  <main class="bg-white rounded-2xl shadow-lg max-w-sm w-full p-10 flex flex-col items-center">
    <div class="text-[#4f8b95] mb-4">
      <img
        alt="Icon representing a receptionist in #4f8b95 color"
        class="w-12 h-12"
        height="48"
        width="48"
        src="https://cdn-icons-png.flaticon.com/512/2830/2830592.png"
        style="filter: invert(34%) sepia(33%) saturate(1443%) hue-rotate(146deg) brightness(87%) contrast(87%);"
      />
    </div>
    <h1 class="text-[#4f8b95] font-semibold text-xl mb-1">Reception Login</h1>
    <p class="text-gray-600 mb-8 text-center text-sm">
      Hospital Management System
    </p>

    <form class="w-full space-y-4" action="ReceptionLoginServlet" method="post">
      <div>
